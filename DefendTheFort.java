...
public final class InputIsEvil // changed class to final
{
    ...
    private static String getOutput()
    {
        ...
        boolean isValid = false;
        	// asking user for only the name of the file without extension and adding ".txt" if input
        	// is validated
        while ( !isValid )
        	{
        		...
        		if ( match.matches() == true && name.length() < 50 )
        		{
        			name += ".txt";
        			isValid = true;
        		}
